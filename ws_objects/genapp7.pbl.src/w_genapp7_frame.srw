$PBExportHeader$w_genapp7_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_genapp7_frame from window
end type
type mdi_1 from mdiclient within w_genapp7_frame
end type
end forward
...
string title = "Frame"
string menuname = "m_genapp7_frame"
...
global w_genapp7_frame w_genapp7_frame

type variables
n_genapp7_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_genapp7_basesheet aw_sheet)
public function long of_classcount (readonly w_genapp7_basesheet aw_sheet)
public function integer of_adjustmenu (ref m_genapp7_frame am_menu)
end prototypes
...
string ls_sheets[]  = { "w_genapp7_sheet1", "w_genapp7_sheet2", "w_genapp7_sheet3" }
...
inv_sheetmgt = Create n_genapp7_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_genapp7_frame.create
if this.MenuName = "m_genapp7_frame" then this.MenuID = create m_genapp7_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_genapp7_frame.destroy
