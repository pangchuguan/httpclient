$PBExportHeader$w_genapp6_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_genapp6_frame from window
end type
type mdi_1 from mdiclient within w_genapp6_frame
end type
end forward
...
string title = "Frame"
string menuname = "m_genapp6_frame"
...
global w_genapp6_frame w_genapp6_frame

type variables
n_genapp6_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_genapp6_basesheet aw_sheet)
...
string ls_sheets[]  = { "w_genapp6_sheet1", "w_genapp6_sheet2", "w_genapp6_sheet3" }
...
inv_sheetmgt = Create n_genapp6_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_genapp6_frame.create
if this.MenuName = "m_genapp6_frame" then this.MenuID = create m_genapp6_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_genapp6_frame.destroy
